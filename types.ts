...
export type AppView = 'LOADING' | 'LANDING' | 'PROFILE_SETUP' | 'DASHBOARD' | 'ENGLISH_SYLLABUS' | 'HOME_ECONOMICS_SYLLABUS' | 'GOVERNMENT_SYLLABUS' | 'AGRICULTURE_SYLLABUS' | 'ARABIC_SYLLABUS' | 'ART_SYLLABUS' | 'BIOLOGY_SYLLABUS' | 'CHEMISTRY_SYLLABUS' | 'LIVE_SESSION' | 'PRIVACY_POLICY' | 'TERMS_OF_SERVICE';
